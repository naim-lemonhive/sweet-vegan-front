...
function BoxHeroSection({size}) {
  ...
  const { productName, midName, text1, text2, backgroundColor } = product;
  // console.log(productName);
  return (
    <div
      style={{ textAlign: "center" }}
    >
      <div className="trapezoid" style={{width: size.width, height: size.height}}>
        <div className="heading" style={{ backgroundColor: '#ffffff' }}>
          <p style={{color: '#4F4F4F'}}>{productName}</p>
        </div>
        <div className="text">
          <div id="burst-12">
            <div className="candy">
